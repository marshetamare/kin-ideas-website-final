...
<html lang="en">
    <head>
        ...
        <title><?= $title . ' | '?> kin ideas Admin Pannel</title>
    ...
    <body>
        ...
        <section id="container">
            ...
            <header class="header white-bg">
                ...
                <!--logo start-->
                <a href="index.php" class="logo">KIN<span> IDEAS ADMIN</span></a>
                <!--logo end-->
            ...
            while ($m = mysqli_fetch_assoc($mail)){
                ...
                <div class="top-nav ">
                    ...
                    <ul class="nav pull-right top-menu">
                        ...
                        <li class="dropdown">
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <img alt="" src="../uploads/logo.jpg" style="width: 35px">
    ...
    if($userData['role'] == 1){ ?>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li <?= $page == 'logo.php' ? 'class="active"' : '' ?>><a  href="../post.php" >View Website</a></li>
                        ...
                        <li class="sub-menu">
                            <a href="javascript:;" <?= $page == 'logo.php' ? 'class="active"' : '' ?> <?= $page == 'social.php' ? 'class="active"' : '' ?> >
                                <i class="fa  fa-globe"></i>
                                <span>Kin music managment dashboard</span>
                            </a>
                            <ul class="sub">
                                <li <?= $page == 'logo.php' ? 'class="active"' : '' ?>><a  href="http://media.kinideas.com/" >kin dashboard</a></li>
