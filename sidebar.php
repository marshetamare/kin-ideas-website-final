<div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
    <div class="sidebar">
        ...
        <div class="widget">
            <h2 class="widget-title" style="margin-bottom: 5px;">Our Services</h2>
            <div class="blog-list-widget">
                <div class="list-group">
                    <?php
                    ...
                    ?>
                    <p style="margin-bottom: 0px;border-bottom: 1px solid #cc"><a href="post.php?id=<?= $row2['id']?>&catwisepost"><?= $row2['category_name'] ?></a></p>
                    <?php } ?>
                </div>
            </div><!-- end blog-list -->
        </div><!-- end widget -->
