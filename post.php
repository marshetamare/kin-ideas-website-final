    ...
    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
        <div class="page-wrapper">
            <div class="blog-top clearfix">
                <h4 class="pull-left">Recent Posts from Kin Ideas <a href="#"><i class="fa fa-rss"></i></a></h4>
            </div><!-- end blog-top -->
            <?php
            if(isset($_GET['catwisepost']) && isset($_GET['id'])){
                ...
                if($catWisepost == false){
                    echo '<h1 class="text-center">Not Available post form Kin ideas !!</h1>';
                }else{
                    while ($catWisepostRow = mysqli_fetch_assoc($catWisepost)) { ?>
                        <div class="blog-list clearfix">
                            <div class="blog-box row text-info">
                                <div class="col-md-4 bg-success">
                                    <div class="post-media ">
                                        <a class=" text-info" href="singlepage.php?id=<?php echo $catWisepostRow['id'] ?>" title="">
                                ...
                                <div class="blog-meta big-meta col-md-8">
                                    <h4 class="bg"><a href="singlepage.php?id=<?= $catWisepostRow['id'] ?>" title=""><?= $catWisepostRow['title'] ?></a></h4>
                                    <p><?php
                                    ...
                                    <small>posted on <a  title="Date and Time"><?= $catWisepostRow['date'] ?></a></small>
                                    <small> by <a  title="Author or Media"><?= $catWisepostRow['admin'] ?></a></small>
                                </div><!-- end meta -->
                            </div><!-- end blog-box -->
                        </div>
                        <hr>
            ...
            elseif (isset($_GET['search-btn'])){
                ...
                if($var == false){
                    echo '<h1 class="text-center">Not Avilable Post from kin ideas !!</h1>';
                }else{
